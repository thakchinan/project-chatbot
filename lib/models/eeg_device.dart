...
/// EEGDevice คือคลาสโมเดลสำหรับจัดเก็บประวัติข้อมูลฮาร์ดแวร์อุปกรณ์สวมใส่ตรวจคลื่นสมอง (เช่น อุปกรณ์ Muse)
/// ประกอบด้วยชื่อเครื่อง รุ่น (Model Name) รหัสเครื่อง (Serial Number) หมายเลข MAC และระดับเปอร์เซ็นต์แบตเตอรี่ล่าสุด
class EEGDevice {
  final int? deviceId;
  final int? userId;
