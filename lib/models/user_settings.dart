...
/// UserSettings คือคลาสโมเดลสำหรับจัดเก็บข้อมูลการตั้งค่าของผู้ใช้งานภายในแอป
/// ประกอบด้วยการตั้งค่าความไววิเคราะห์คลื่นสมอง การเปิดรับการแจ้งเตือน ธีมหน้าจอ (Dark Mode) และขนาดฟอนต์อักษร
class UserSettings {
  final int? id;
  final int userId;
